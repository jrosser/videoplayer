...
contains(DEFINES, HAVE_DIRAC) {
	...
	LIBPATH += $$PARSER_PATH/build
	#LIBS += -ldirac1.0_parser -ldirac1.0_samples
	LIBS += -lparser -lsamples
	...
	SCHRO_PATH = /project/compression/jrosser/workspace/schroedinger
	SCHRO_INSTALL_PATH = /project/compression/jrosser/workspace/schro-amd64
	INCLUDEPATH += $$SCHRO_PATH
	INCLUDEPATH += $$SCHRO_INSTALL_PATH/include/schroedinger-0.9
	LIBPATH += $$SCHRO_INSTALL_PATH/lib
	LIBS += -lschroedinger-0.9
}
